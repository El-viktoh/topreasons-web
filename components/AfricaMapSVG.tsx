export const AfricaMapSVG = ({ className }: { className?: string }) => {
  ...
  return (
    ...
    >
      <g transform="translate(0, 1024) scale(0.1, -0.1)" fill="none" stroke="#F3A712">
        {/* Outer thick boundary */}
        <path d={pathData} strokeWidth="40" strokeLinecap="round" strokeLinejoin="round" />
        
        {/* Topographic geometric inner rings */}
        <g transform="translate(5120, 5120) scale(0.9) translate(-5120, -5120)">
          <path d={pathData} strokeWidth="30" strokeDasharray="300 200" strokeLinecap="round" strokeLinejoin="round" />
        </g>
        
        <g transform="translate(5120, 5120) scale(0.8) translate(-5120, -5120)">
          <path d={pathData} strokeWidth="25" strokeLinecap="round" strokeLinejoin="round" />
        </g>
        
        <g transform="translate(5120, 5120) scale(0.7) translate(-5120, -5120)">
          <path d={pathData} strokeWidth="20" strokeDasharray="150 150" strokeLinecap="round" strokeLinejoin="round" />
        </g>
        
        <g transform="translate(5120, 5120) scale(0.6) translate(-5120, -5120)">
          <path d={pathData} strokeWidth="20" strokeLinecap="round" strokeLinejoin="round" />
        </g>
        
        <g transform="translate(5120, 5120) scale(0.5) translate(-5120, -5120)">
          <path d={pathData} strokeWidth="15" strokeDasharray="400 100" strokeLinecap="round" strokeLinejoin="round" />
        </g>
        
        <g transform="translate(5120, 5120) scale(0.4) translate(-5120, -5120)">
          <path d={pathData} strokeWidth="15" strokeLinecap="round" strokeLinejoin="round" />
        </g>
        
        <g transform="translate(5120, 5120) scale(0.25) translate(-5120, -5120)">
          <path d={pathData} strokeWidth="10" strokeDasharray="100 100" strokeLinecap="round" strokeLinejoin="round" />
        </g>
        
        {/* Additional geometric tribal accents */}
        <circle cx="2000" cy="5000" r="400" strokeWidth="20" strokeDasharray="100 100" />
        <circle cx="2000" cy="5000" r="200" strokeWidth="15" />
        <circle cx="8000" cy="7000" r="300" strokeWidth="20" />
        <circle cx="8000" cy="7000" r="150" strokeWidth="10" strokeDasharray="50 50" />
        
        <line x1="3000" y1="2000" x2="7000" y2="8000" strokeWidth="15" strokeDasharray="300 200" />
        <line x1="7000" y1="3000" x2="4000" y2="8000" strokeWidth="15" strokeDasharray="200 300" />
      </g>
    </svg>
  );
};
